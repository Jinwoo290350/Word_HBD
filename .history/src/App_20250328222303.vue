    ...
    <div class="card p-4 shadow">
      <div class="mb-3">
        ...
        <input 
          ...
          type="text" 
          class="form-control" 
          placeholder="เช่น น้อง Frank my sugar daddy"
        >
      </div>
      ...
      <div class="mb-3">
        ...
        <select v-model="theme" class="form-select">
          ...
          <option value="คนเอเชีย ที่ชอบถามว่าเมื่อไรจะเป็นหมอ">เอเชีย</option>
          <option value="คนหยาบคาย">🥰 น่ารักก็เหี้ยละ</option>
        </select>
      </div>
