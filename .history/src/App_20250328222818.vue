    ...
    <div class="card p-4 shadow">
      ...
      <div class="mb-3">
        ...
        <select v-model="theme" class="form-select">
          ...
          <option value="คนดำ พูดจาไม่ดี ชอบเล่นบาส กินไก่ทอดกับแตงโม">🏀 Basketball Pro</option>
          <option value="ซักเกอร์แดดดี้">💵 Sugardaddy</option>
          <option value="โรบล็อกซ์">🎮 Roblox Master</option>
          <option value="อิสลาม">🕌 Islamic Style</option>
          <option value="คนทั่วไป">😊 ทั่วไป</option>
          <option value="คนเอเชีย ที่ชอบถามว่าเมื่อไรจะเป็นหมอ">👨⚕️ Asian Parent</option>
          <option value="คนหยาบคาย">🤬 สุดเท่(แต่ดุดัน)</option>
        </select>
      </div>
